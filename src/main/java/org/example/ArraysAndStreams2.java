...
public class ArraysAndStreams2 {
   public static void main(String[] args) {
      ...
      // concatenate all strings into a single string, separated by commas
      System.out.printf("all strings concatenated with commas: %s%n",
              Arrays.stream(strings)
      ...
      long count = Arrays.stream(strings)
              .filter(s -> s.length() > 5)
              .count();
      System.out.printf("count of strings with more than 5 characters: %d%n", count);
   }
